...
#    define CATCH_INTERNAL_START_WARNINGS_SUPPRESSION _Pragma\
  ( "GCC diagnostic push" )
#    define CATCH_INTERNAL_STOP_WARNINGS_SUPPRESSION  _Pragma\
  ( "GCC diagnostic pop" )

#    define CATCH_INTERNAL_IGNORE_BUT_WARN(...) (void)__builtin_constant_p(\
    __VA_ARGS__)
...
#  define INTERNAL_CATCH_UNIQUE_NAME(name) INTERNAL_CATCH_UNIQUE_NAME_LINE(name, \
    __COUNTER__)
#else
#  define INTERNAL_CATCH_UNIQUE_NAME(name) INTERNAL_CATCH_UNIQUE_NAME_LINE(name, \
    __LINE__)
...
#define CATCH_RECURSION_LEVEL1(...) CATCH_RECURSION_LEVEL0(CATCH_RECURSION_LEVEL0(\
      CATCH_RECURSION_LEVEL0(\
        __VA_ARGS__)))
#define CATCH_RECURSION_LEVEL2(...) CATCH_RECURSION_LEVEL1(CATCH_RECURSION_LEVEL1(\
      CATCH_RECURSION_LEVEL1(\
        __VA_ARGS__)))
#define CATCH_RECURSION_LEVEL3(...) CATCH_RECURSION_LEVEL2(CATCH_RECURSION_LEVEL2(\
      CATCH_RECURSION_LEVEL2(\
        __VA_ARGS__)))
#define CATCH_RECURSION_LEVEL4(...) CATCH_RECURSION_LEVEL3(CATCH_RECURSION_LEVEL3(\
      CATCH_RECURSION_LEVEL3(\
        __VA_ARGS__)))
#define CATCH_RECURSION_LEVEL5(...) CATCH_RECURSION_LEVEL4(CATCH_RECURSION_LEVEL4(\
...
#define CATCH_RECURSION_LEVEL6(...) CATCH_RECURSION_LEVEL5(CATCH_RECURSION_LEVEL5(\
      CATCH_RECURSION_LEVEL5(\
        __VA_ARGS__)))
#define CATCH_RECURSE(...)  CATCH_RECURSION_LEVEL6(CATCH_RECURSION_LEVEL6(\
      __VA_ARGS__))
#else
...
#define CATCH_REC_LIST0_UD(f, userdata, x, peek, ...) , \
  f(userdata, x) CATCH_DEFER(CATCH_REC_NEXT(peek, CATCH_REC_LIST1_UD) ) ( f, \
  userdata, peek, __VA_ARGS__ )
#define CATCH_REC_LIST1_UD(f, userdata, x, peek, ...) , \
  f(userdata, x) CATCH_DEFER(CATCH_REC_NEXT(peek, CATCH_REC_LIST0_UD) ) ( f, \
  userdata, peek, __VA_ARGS__ )
#define CATCH_REC_LIST2_UD(f, userdata, x, peek, ...)   f(userdata, \
    x) CATCH_DEFER(CATCH_REC_NEXT(peek, CATCH_REC_LIST1_UD) ) ( f, userdata, \
  peek, __VA_ARGS__ )
...
#define INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS(param) INTERNAL_CATCH_STRINGIZE(INTERNAL_CATCH_REMOVE_PARENS(\
      param))
#else
// MSVC is adding extra space and needs another indirection to expand INTERNAL_CATCH_NOINTERNAL_CATCH_DEF
#define INTERNAL_CATCH_STRINGIZE2(...) INTERNAL_CATCH_STRINGIZE3(__VA_ARGS__)
#define INTERNAL_CATCH_STRINGIZE3(...) #__VA_ARGS__
#define INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS(param) (INTERNAL_CATCH_STRINGIZE(\
    INTERNAL_CATCH_REMOVE_PARENS(param)) + 1)
#endif

#define INTERNAL_CATCH_MAKE_NAMESPACE2(...) ns_##__VA_ARGS__
#define INTERNAL_CATCH_MAKE_NAMESPACE(name) INTERNAL_CATCH_MAKE_NAMESPACE2(name)

#define INTERNAL_CATCH_REMOVE_PARENS(...) INTERNAL_CATCH_EXPAND1(\
    INTERNAL_CATCH_DEF __VA_ARGS__)

#ifndef CATCH_CONFIG_TRADITIONAL_MSVC_PREPROCESSOR
#define INTERNAL_CATCH_MAKE_TYPE_LIST2(...) decltype(get_wrapper<INTERNAL_CATCH_REMOVE_PARENS_GEN(\
    __VA_ARGS__)>())
#define INTERNAL_CATCH_MAKE_TYPE_LIST(...) INTERNAL_CATCH_MAKE_TYPE_LIST2(INTERNAL_CATCH_REMOVE_PARENS(\
      __VA_ARGS__))
#else
#define INTERNAL_CATCH_MAKE_TYPE_LIST2(...) INTERNAL_CATCH_EXPAND_VARGS(decltype(\
      get_wrapper<INTERNAL_CATCH_REMOVE_PARENS_GEN(\
        __VA_ARGS__)>()))
#define INTERNAL_CATCH_MAKE_TYPE_LIST(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_MAKE_TYPE_LIST2(\
...
#define INTERNAL_CATCH_REMOVE_PARENS_2_ARG(_0, _1) INTERNAL_CATCH_REMOVE_PARENS(\
    _0), INTERNAL_CATCH_REMOVE_PARENS_1_ARG(_1)
#define INTERNAL_CATCH_REMOVE_PARENS_3_ARG(_0, _1, \
    _2) INTERNAL_CATCH_REMOVE_PARENS(_0), INTERNAL_CATCH_REMOVE_PARENS_2_ARG(_1, \
    _2)
#define INTERNAL_CATCH_REMOVE_PARENS_4_ARG(_0, _1, _2, \
    _3) INTERNAL_CATCH_REMOVE_PARENS(_0), INTERNAL_CATCH_REMOVE_PARENS_3_ARG(_1, \
    _2, \
    _3)
#define INTERNAL_CATCH_REMOVE_PARENS_5_ARG(_0, _1, _2, _3, \
    _4) INTERNAL_CATCH_REMOVE_PARENS(_0), INTERNAL_CATCH_REMOVE_PARENS_4_ARG(_1, \
    _2, \
    _3, \
    _4)
#define INTERNAL_CATCH_REMOVE_PARENS_6_ARG(_0, _1, _2, _3, _4, \
    ...
    _4, \
    _5)
#define INTERNAL_CATCH_REMOVE_PARENS_7_ARG(_0, _1, _2, _3, _4, _5, \
    _6) INTERNAL_CATCH_REMOVE_PARENS(_0), INTERNAL_CATCH_REMOVE_PARENS_6_ARG(_1, \
    _2, \
    _3, \
    _4, \
    _5, \
    _6)
#define INTERNAL_CATCH_REMOVE_PARENS_8_ARG(_0, _1, _2, _3, _4, _5, _6, \
    _7) INTERNAL_CATCH_REMOVE_PARENS(_0), INTERNAL_CATCH_REMOVE_PARENS_7_ARG(_1, \
    _2, \
    _3, \
    _4, \
    _5, \
...
#define INTERNAL_CATCH_REMOVE_PARENS_9_ARG(_0, _1, _2, _3, _4, _5, _6, _7, \
    ...
    _7, \
    _8)
#define INTERNAL_CATCH_REMOVE_PARENS_10_ARG(_0, _1, _2, _3, _4, _5, _6, _7, _8, \
    _9) INTERNAL_CATCH_REMOVE_PARENS(_0), \
  INTERNAL_CATCH_REMOVE_PARENS_9_ARG(_1, _2, _3, _4, _5, _6, _7, _8, _9)
#define INTERNAL_CATCH_REMOVE_PARENS_11_ARG(_0, _1, _2, _3, _4, _5, _6, _7, _8, \
    _9, \
    _10) INTERNAL_CATCH_REMOVE_PARENS(_0), INTERNAL_CATCH_REMOVE_PARENS_10_ARG(\
...
#define INTERNAL_CATCH_TYPE_GEN\
  ...
  struct append<L1<E1...>, TypeList<mpl_::na>, \
    Rest...> { using type = L1<E1...>; };\
    \
  ...
  struct rewrap<TemplateTypeList<Container>, List<Elems...>, \
    Elements...> { using type = typename append<TypeList<Container<Elems...>>, \
  ...
  template<template<typename...> class Final, template<typename...> class List, \
    typename... Ts>\
  struct convert<Final, List<Ts...>> { using type = typename append<Final<>,\
        TypeList<Ts>...>::type; };
...
#define INTERNAL_CATCH_NTTP_1(signature, ...)\
  ...
  template<template<INTERNAL_CATCH_REMOVE_PARENS(signature)> class...> struct \
...
#define INTERNAL_CATCH_NTTP_REGISTER0(TestFunc, signature)\
  ...
  {\
    Catch::AutoReg(Catch::makeTestInvoker(\
        &TestFunc<Type>), CATCH_INTERNAL_LINEINFO, Catch::StringRef(), \
      nameAndTags);\
  }
...
#define INTERNAL_CATCH_NTTP_REGISTER(TestFunc, signature, ...)\
  ...
  {\
    Catch::AutoReg(Catch::makeTestInvoker(\
        &TestFunc<__VA_ARGS__>), CATCH_INTERNAL_LINEINFO, \
...
#define INTERNAL_CATCH_NTTP_REGISTER_METHOD0(TestName, signature, ...)\
  ...
  {\
    Catch::AutoReg(Catch::makeTestInvoker(\
        &TestName<Type>::test), CATCH_INTERNAL_LINEINFO, className, \
      nameAndTags);\
  }
...
#define INTERNAL_CATCH_NTTP_REGISTER_METHOD(TestName, signature, ...)\
  ...
  {\
    Catch::AutoReg(Catch::makeTestInvoker(\
        &TestName<__VA_ARGS__>::test), CATCH_INTERNAL_LINEINFO, className, \
      nameAndTags);\
  }
...
#define INTERNAL_CATCH_NTTP_GEN(...) INTERNAL_CATCH_VA_NARGS_IMPL(__VA_ARGS__, INTERNAL_CATCH_NTTP_1(\
...
#define INTERNAL_CATCH_NTTP_REG_METHOD_GEN(TestName, \
    ...
    INTERNAL_CATCH_NTTP_REGISTER_METHOD0)(\
    TestName, __VA_ARGS__)
#define INTERNAL_CATCH_NTTP_REG_GEN(TestFunc, ...) INTERNAL_CATCH_VA_NARGS_IMPL( \
    "dummy", __VA_ARGS__, INTERNAL_CATCH_NTTP_REGISTER, \
    INTERNAL_CATCH_NTTP_REGISTER, INTERNAL_CATCH_NTTP_REGISTER, \
    INTERNAL_CATCH_NTTP_REGISTER, INTERNAL_CATCH_NTTP_REGISTER, \
    INTERNAL_CATCH_NTTP_REGISTER, INTERNAL_CATCH_NTTP_REGISTER, \
    INTERNAL_CATCH_NTTP_REGISTER, INTERNAL_CATCH_NTTP_REGISTER, \
    INTERNAL_CATCH_NTTP_REGISTER0, INTERNAL_CATCH_NTTP_REGISTER0)(TestFunc, \
  __VA_ARGS__)
...
#define INTERNAL_CATCH_DEFINE_SIG_TEST(TestName, \
    ...
    INTERNAL_CATCH_DEFINE_SIG_TEST_X, INTERNAL_CATCH_DEFINE_SIG_TEST_X, \
    INTERNAL_CATCH_DEFINE_SIG_TEST_X, INTERNAL_CATCH_DEFINE_SIG_TEST_X,\
    INTERNAL_CATCH_DEFINE_SIG_TEST1, INTERNAL_CATCH_DEFINE_SIG_TEST0)(TestName, \
    __VA_ARGS__))
#define INTERNAL_CATCH_DECLARE_SIG_TEST(TestName, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_VA_NARGS_IMPL("dummy", \
...
#define INTERNAL_CATCH_REMOVE_PARENS_GEN(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_VA_NARGS_IMPL(\
      __VA_ARGS__, INTERNAL_CATCH_REMOVE_PARENS_11_ARG,\
      INTERNAL_CATCH_REMOVE_PARENS_10_ARG, INTERNAL_CATCH_REMOVE_PARENS_9_ARG,\
      INTERNAL_CATCH_REMOVE_PARENS_8_ARG, INTERNAL_CATCH_REMOVE_PARENS_7_ARG,\
      INTERNAL_CATCH_REMOVE_PARENS_6_ARG, INTERNAL_CATCH_REMOVE_PARENS_5_ARG,\
...
struct is_callable_tester
{
  ...
  true_given<decltype(std::declval<Fun>()(std::declval<Args>()...))> static test(
    int);
  template<typename...>
...
template<typename Fun, typename... Args>
struct is_callable<Fun(Args...)>: decltype(is_callable_tester::test<Fun,
  Args...>(0)) {};
...
using FunctionReturnType = std::remove_reference_t<std::remove_cv_t<std::invoke_result_t<Func,
    U...>>>;
#else
// Keep ::type here because we still support C++11
template<typename Func, typename... U>
using FunctionReturnType =
  typename std::remove_reference<typename std::remove_cv<typename std::result_of<Func(U...)>::type>::type>
  ::
  type;
#endif
...
struct AutoReg : NonCopyable
{
  ...
  namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestName) {                                      \
    INTERNAL_CATCH_DECLARE_SIG_TEST_METHOD(TestName, ClassName, INTERNAL_CATCH_REMOVE_PARENS(\
        Signature));\
  }                                                                                           \
  }                                                                                           \
  ...
  INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION_2(INTERNAL_CATCH_UNIQUE_NAME( \
    ...
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), Name, Tags, typename TestType, \
    __VA_ARGS__)
    #else
        #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION(Name, Tags, \
    ...) \
  ...
  INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION_2(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), \
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), Name, Tags, Signature, \
    __VA_ARGS__)
    #else
        #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_SIG_NO_REGISTRATION(Name, \
    Tags, \
  ...
  INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2(INTERNAL_CATCH_UNIQUE_NAME( \
    ...
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), ClassName, Name, Tags, typename T, \
    __VA_ARGS__)
    #else
        #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION( \
    ClassName, Name, Tags, ...) \
  ...
  INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_C_L_A_S_S_), \
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), ClassName, Name, Tags, Signature, \
    __VA_ARGS__)
    #else
        #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_SIG_NO_REGISTRATION( \
    ClassName, Name, Tags, Signature, ...) \
...
///////////////////////////////////////////////////////////////////////////////
  ...
  CATCH_INTERNAL_START_WARNINGS_SUPPRESSION \
    CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS \
  namespace { Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)( Catch::\
  makeTestInvoker(&TestName), CATCH_INTERNAL_LINEINFO, Catch::StringRef(), \
...
///////////////////////////////////////////////////////////////////////////////
  ...
  CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS \
  namespace { Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)( Catch::\
  makeTestInvoker(&QualifiedMethod), CATCH_INTERNAL_LINEINFO, \
...
///////////////////////////////////////////////////////////////////////////////
  ...
  Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar) ( Catch::\
  makeTestInvoker(&TestName::test), CATCH_INTERNAL_LINEINFO, #ClassName, \
  Catch::NameAndTags{ __VA_ARGS__ } ); /* NOLINT */ \
  } \
  CATCH_INTERNAL_STOP_WARNINGS_SUPPRESSION \
  void TestName::test()
...
///////////////////////////////////////////////////////////////////////////////
  ...
  CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS \
  Catch::AutoReg INTERNAL_CATCH_UNIQUE_NAME(autoRegistrar)( Catch::\
  makeTestInvoker(Function), CATCH_INTERNAL_LINEINFO, Catch::StringRef(), \
  Catch::NameAndTags{ __VA_ARGS__ } ); /* NOLINT */ \
  CATCH_INTERNAL_STOP_WARNINGS_SUPPRESSION
...
///////////////////////////////////////////////////////////////////////////////
  ...
  namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestName) {\
    ...
    INTERNAL_CATCH_NTTP_REG_GEN(TestFunc, INTERNAL_CATCH_REMOVE_PARENS(\
        Signature))\
  ...
  INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_2( \
    ...
    #define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE2(TestName, TestFuncName, \
    Name, Tags, Signature, \
    TmplTypes, TypesList) \
  CATCH_INTERNAL_START_WARNINGS_SUPPRESSION                      \
  CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS                      \
  ...
  namespace INTERNAL_CATCH_MAKE_NAMESPACE(TestName) {                                     \
    ...
    struct TestName {                                         \
      void reg_tests() {                                          \
        ...
        using expander = int[];                           \
        constexpr char const* tmpl_types[] = {CATCH_REC_LIST(\
            INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS, INTERNAL_CATCH_REMOVE_PARENS(\
              TmplTypes))};\
        ...
        (void)expander{(Catch::AutoReg(Catch::makeTestInvoker(&TestFuncName<Types>), \
          ...
          Catch::NameAndTags{ Name " - " + \
            ...
            std::string(types_list[index % num_types]) + ">", Tags }), \
          index++)... }; /* NOLINT */\
      }                                                     \
    };                                                        \
    static int INTERNAL_CATCH_UNIQUE_NAME(globalRegistrar) = []() { \
  ...
  INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE2(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), \
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), Name, Tags, typename T,\
    __VA_ARGS__)
#else
    #define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE(Name, Tags, ...)\
  ...
  INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_2(INTERNAL_CATCH_UNIQUE_NAME( \
    ...
    #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_2(TestNameClass, TestName, \
    ClassName, Name, Tags, \
    Signature, ...) \
  CATCH_INTERNAL_START_WARNINGS_SUPPRESSION \
  CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS \
      ...
      void reg_tests() {\
        ...
        constexpr char const* types_list[] = {CATCH_REC_LIST(\
            INTERNAL_CATCH_STRINGIZE_WITHOUT_PARENS, INTERNAL_CATCH_REMOVE_PARENS(\
              TypesList))};\
        constexpr auto num_types = sizeof(types_list) / sizeof(types_list[0]);\
        (void)expander{(Catch::AutoReg(Catch::makeTestInvoker(&TestName<Types>::\
          test), CATCH_INTERNAL_LINEINFO, #ClassName, \
          Catch::NameAndTags{ Name " - " + \
            std::string(tmpl_types[index / num_types]) + "<" + \
            std::string(types_list[index % num_types]) + ">", Tags }), \
          index++)... }; /* NOLINT */ \
  ...
  INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), \
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), ClassName, Name, Tags, typename T, \
    __VA_ARGS__)
#else
    #define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD(ClassName, Name, \
    Tags, ...)\
  ...
  INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), \
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), ClassName, Name, Tags, Signature, \
    __VA_ARGS__)
#else
    #define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(ClassName, \
    Name, Tags, \
...
#define INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD(ClassName, Name, Tags, \
  ...
  INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD_2(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_), \
    INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_), ClassName, Name, Tags, \
    TmplList)
...
{
  return ::Catch::StringMaker<typename std::remove_cv<typename std::remove_reference<T>::type>::type>
    ::convert(e);
}
...
std::string convertUnknownEnumToString(E e)
{
  return ::Catch::Detail::stringify(static_cast<typename std::underlying_type<E>
      ::type>(e));
}
...
struct is_range_impl<T,
  typename void_type<decltype(begin(std::declval<T>()))>::type>: std::
  true_type
{
};
} // namespace detail
  ...
  template<> struct StringMaker<enumName> { \
    static std::string convert(enumName value) { \
      static const auto& enumInfo = \
        ::Catch::getMutableRegistryHub().getMutableEnumValuesRegistry().\
...
#define CATCH_REGISTER_ENUM(enumName, ...) INTERNAL_CATCH_REGISTER_ENUM( \
...
class BinaryExpr  : public ITransientExpression
{
  ...
  {
    formatReconstructedExpression(os, Catch::Detail::stringify(
...
#define INTERNAL_CATCH_CATCH(handler) catch (...) { handler.\
...
#define INTERNAL_CATCH_TEST(macroName, resultDisposition, ...) \
  do { \
    ...
    Catch::AssertionHandler catchAssertionHandler(macroName##_catch_sr, \
      CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(\
        __VA_ARGS__), resultDisposition); \
    INTERNAL_CATCH_TRY { \
      CATCH_INTERNAL_START_WARNINGS_SUPPRESSION \
...
#define INTERNAL_CATCH_THROWS_AS(macroName, exceptionType, resultDisposition, \
  ...
  do { \
    Catch::AssertionHandler catchAssertionHandler(macroName##_catch_sr, \
      CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(\
        expr) ", " CATCH_INTERNAL_STRINGIFY(exceptionType), resultDisposition); \
    if (catchAssertionHandler.allowThrows() ) \
    try { \
...
#define INTERNAL_CATCH_INFO(macroName, log) \
  Catch::ScopedMessage INTERNAL_CATCH_UNIQUE_NAME(scopedMessage)( Catch::\
  MessageBuilder(macroName##_catch_sr, CATCH_INTERNAL_LINEINFO, \
  Catch::ResultWas::Info) << log );

///////////////////////////////////////////////////////////////////////////////
#define INTERNAL_CATCH_UNSCOPED_INFO(macroName, log) \
  Catch::getResultCapture().emplaceUnscopedMessage(Catch::MessageBuilder( \
...
#define INTERNAL_CATCH_THROWS_STR_MATCHES(macroName, resultDisposition, matcher, \
  ...
  do { \
    Catch::AssertionHandler catchAssertionHandler(macroName##_catch_sr, \
      CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(\
        __VA_ARGS__) ", " CATCH_INTERNAL_STRINGIFY(matcher), resultDisposition); \
    if (catchAssertionHandler.allowThrows() ) \
    try { \
      static_cast<void>(__VA_ARGS__); \
      catchAssertionHandler.handleUnexpectedExceptionNotThrown(); \
...
public:
  ...
  {
    getMutableRegistryHub().registerTranslator(new ExceptionTranslator<T>(
        translateFunction) );
  }
};
}
...
public:
  ...
  template<typename T,
    typename = typename std::enable_if<std::is_constructible<double,
    T>::value>::type>
...
Vector::ContainsMatcher<T, AllocComp, AllocMatch> Contains(std::vector<T,
...
template<typename T, typename AllocComp = std::allocator<T>,
  typename AllocMatch = AllocComp>
Vector::EqualsMatcher<T, AllocComp, AllocMatch> Equals(std::vector<T,
  AllocComp> const& comparator)
{
...
template<typename T, typename AllocComp = std::allocator<T>,
  typename AllocMatch = AllocComp>
Vector::ApproxMatcher<T, AllocComp, AllocMatch> Approx(std::vector<T,
  AllocComp> const& comparator)
{
...
#define INTERNAL_CHECK_THAT(macroName, matcher, resultDisposition, arg) \
  do { \
    Catch::AssertionHandler catchAssertionHandler(macroName##_catch_sr, \
      CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(\
        arg) ", " CATCH_INTERNAL_STRINGIFY(matcher), resultDisposition); \
    INTERNAL_CATCH_TRY { \
...
#define INTERNAL_CATCH_THROWS_MATCHES(macroName, exceptionType, \
  ...
  do { \
    Catch::AssertionHandler catchAssertionHandler(macroName##_catch_sr, \
      CATCH_INTERNAL_LINEINFO, CATCH_INTERNAL_STRINGIFY(\
        __VA_ARGS__) ", " CATCH_INTERNAL_STRINGIFY(\
...
{
  return GeneratorWrapper<T>(pf::make_unique<SingleValueGenerator<T>>(std::
      forward<T>(value)));
}
template<typename T>
...
auto generate(StringRef generatorName, SourceLineInfo const& lineInfo,
  L const& generatorExpression) -> decltype(std::declval<decltype(
  generatorExpression())>().get())
{
...
#define GENERATE(...) \
  Catch::Generators::generate(INTERNAL_CATCH_STRINGIZE(\
...
template<typename T>
typename std::enable_if<std::is_integral<T>::value && !std::is_same<T,
  bool>::value,
...
{
  return GeneratorWrapper<ResultType>(pf::make_unique<IteratorGenerator<ResultType>>(
        from,
        to));
}
      ...
      for (u_int m = 0; m < count; m++)
      {
        ...
        if (startsWith(methodName, "Catch_TestCase_") )
        {
          ...
          getMutableRegistryHub().registerTest(makeTestCase(new OcMethod(cls,
            selector), className, NameAndTags(name.c_str(), desc.c_str() ),
            SourceLineInfo("", 0) ) );
          noTestMethods++;
        }
      }
...
struct BenchmarkStats
{
  ...
  operator BenchmarkStats<Duration2>() const
  {
    ...
    std::transform(samples.begin(), samples.end(), std::back_inserter(
        samples2), [](Duration d) { return Duration2(d); });
    return {
      info,
      std::move(samples2),
      mean,
...
struct CumulativeReporterBase : IStreamingReporter
{
  ...
  bool assertionEnded(AssertionStats const& assertionStats) override
  {
    ...
    prepareExpandedExpression(const_cast<AssertionResult&>( assertionStats.
      assertionResult ) );
...
#define CATCH_REGISTER_REPORTER(name, reporterType) \
  CATCH_INTERNAL_START_WARNINGS_SUPPRESSION         \
  CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS          \
  namespace { Catch::ReporterRegistrar<reporterType> catch_internal_RegistrarFor\
  ##reporterType(name); } \
  CATCH_INTERNAL_STOP_WARNINGS_SUPPRESSION
...
#define CATCH_REGISTER_LISTENER(listenerType) \
  CATCH_INTERNAL_START_WARNINGS_SUPPRESSION   \
  CATCH_INTERNAL_SUPPRESS_GLOBALS_WARNINGS    \
  namespace { Catch::ListenerRegistrar<listenerType> catch_internal_RegistrarFor\
  ##listenerType; } \
  CATCH_INTERNAL_STOP_WARNINGS_SUPPRESSION
...
inline auto invoke_deoptimized(Fn&& fn,
  Args&&... args) -> typename std::enable_if<!std::is_same<void,
  ...
  ClockDuration<Clock> how_long, int seed, Fun&& fun)
{
  ...
  while (iters < (1 << 30))
  {
    auto&& Timing = measure_one<Clock>(fun, iters, is_callable<Fun(
          Chronometer)>());
...
struct ExecutionPlan
{
  ...
  {
    // warmup a bit
    Detail::run_for_at_least<Clock>(std::chrono::duration_cast<ClockDuration<Clock>>(
        warmup_time), warmup_iterations, Detail::repeat(now<Clock>{}));
  ...
  Estimator&& estimator)
{
  ...
  std::tie(sum_squares, sum_cubes) = std::accumulate(jack.begin(),
      jack.end(), std::make_pair(0., 0.), [jack_mean](std::pair<double,
      double> sqcb, double x) -> std::pair<double, double>
      {
        auto d = jack_mean - x;
        auto d2 = d * d;
        auto d3 = d2 * d;
  ...
  double prob_n =
    std::count_if(resample.begin(), resample.end(), [point](double x)
      {
        return x < point;
      }) / (double)n;
...
int warmup()
{
  return run_for_at_least<Clock>(std::chrono::duration_cast<ClockDuration<Clock>>(
        warmup_time), warmup_seed, &resolution<Clock>)
    .iterations;
}
template<typename Clock>
  ...
  Iterator first, Iterator last)
{
  if (!cfg.benchmarkNoAnalysis())
  {
    ...
    samples2.reserve(samples.size());
    std::transform(samples.begin(), samples.end(), std::back_inserter(
        samples2), [](double d) { return Duration(d); });
    return {
      std::move(samples2),
...
struct Benchmark
{
  ...
  const
  {
    ...
    auto&& test = Detail::run_for_at_least<Clock>(std::chrono::duration_cast<ClockDuration<Clock>>(
          run_time), 1, fun);
    int new_iters =
      static_cast<int>(std::ceil(min_time * test.iterations /
      test.elapsed));
    return { new_iters,
      test.elapsed / test.iterations * new_iters * cfg.benchmarkSamples(),
      fun, std::chrono::duration_cast<FloatDuration<Clock>>(
        cfg.benchmarkWarmupTime()), Detail::warmup_iterations };
  }
...
double outlier_variance(Estimate<double> mean, Estimate<double> stddev, int n)
{
  ...
  return (std::min)(var_out(1),
    var_out((std::min)(c_max(0.), c_max(mg_min)))) / sb2;
}
...
public:
  class iterator
  {
    ...
    {
      auto initial = m_pos == 0 &&
        m_stringIndex == 0 ? m_column.m_initialIndent : std::string::npos;
...
#if !defined(CATCH_PLATFORM_WINDOWS) && ( defined(WIN32) || \
...
struct Parser : ParserBase
{
  ...
  auto operator|=(Parser const& other) -> Parser&
  {
    m_options.insert(m_options.end(),
      other.m_options.begin(), other.m_options.end());
    ...
    TokenStream const& tokens) const -> InternalParseResult override
  {
    ...
    auto result =
      InternalParseResult::ok(ParseState(ParseResultType::NoMatch,
        tokens) );
...
public:
  ...
  void use(Colour::Code _colourCode) override
  {
    switch (_colourCode)
    {
      case Colour::None:      return setTextAttribute(
          originalForegroundAttributes);
      case Colour::White:     return setTextAttribute(
          FOREGROUND_GREEN | FOREGROUND_RED | FOREGROUND_BLUE);
      case Colour::Red:       return setTextAttribute(FOREGROUND_RED);
      case Colour::Green:     return setTextAttribute(FOREGROUND_GREEN);
      case Colour::Blue:      return setTextAttribute(FOREGROUND_BLUE);
      case Colour::Cyan:      return setTextAttribute(
      ...
      case Colour::BrightRed:     return setTextAttribute(
          FOREGROUND_INTENSITY | FOREGROUND_RED);
      case Colour::BrightGreen:   return setTextAttribute(
          FOREGROUND_INTENSITY | FOREGROUND_GREEN);
      case Colour::BrightWhite:   return setTextAttribute(
          FOREGROUND_INTENSITY | FOREGROUND_GREEN | FOREGROUND_RED |
          FOREGROUND_BLUE);
      case Colour::BrightYellow:  return setTextAttribute(
...
std::size_t listTests(Config const& config)
{
  ...
  if (!config.hasTestFilters() )
    Catch::cout() <<
      pluralise(matchedTestCases.size(), "test case") << '\n' << std::endl;
  else
    Catch::cout() <<
...
StdString::EqualsMatcher Equals(std::string const& str,
  CaseSensitive::Choice caseSensitivity)
{
  return StdString::EqualsMatcher(StdString::CasedString(str,
      caseSensitivity) );
}
StdString::ContainsMatcher Contains(std::string const& str,
  CaseSensitive::Choice caseSensitivity)
...
TempFile::TempFile()
{
  ...
  if (fopen_s(&m_file, m_buffer, "w+"))
  {
    ...
    CATCH_RUNTIME_ERROR(
        "Could not open the temp file: '" << m_buffer << "' because: " <<
        buffer);
  }
}
#else
...
public: // IRegistryHub
  ...
  IExceptionTranslatorRegistry const& getExceptionTranslatorRegistry() const
  override
  {
...
using RegistryHubSingleton = Singleton<RegistryHub, IRegistryHub,
    IMutableRegistryHub>;
...
std::string translateActiveException()
{
  return getRegistryHub().getExceptionTranslatorRegistry().
...
Totals RunContext::runTest(TestCase const& testCase)
{
  ...
  static_cast<SectionTracker&>(rootTracker).addInitialFilters(
    m_config->getSectionsToRun());
  do
  {
    m_trackerContext.startCycle();
    m_testCaseTracker = &SectionTracker::acquire(m_trackerContext, TestCaseTracking::NameAndLocation(
          testInfo.name,
          testInfo.lineInfo));
...
bool RunContext::sectionStarted(SectionInfo const& sectionInfo,
  Counts& assertions)
{
  ITracker& sectionTracker = SectionTracker::acquire(m_trackerContext, TestCaseTracking::NameAndLocation(
        sectionInfo.name,
  ...
  std::string& redirectedCerr)
{
  ...
  m_lastAssertionInfo =
  { "TEST_CASE"_sr, testCaseInfo.lineInfo, StringRef(),
    ResultDisposition::Normal };
  ...
  CATCH_TRY {
    ...
    if (m_shouldReportUnexpected)
    {
      ...
      handleUnexpectedInflightException(m_lastAssertionInfo,
        translateActiveException(), dummyReaction);
    }
  }
...
Session::Session()
{
  ...
  {
    CATCH_TRY { CATCH_INTERNAL_ERROR(
...
struct StringStreams
{
  ...
  auto add() -> std::size_t
  {
    if (m_unused.empty() )
    {
      m_streams.push_back(std::unique_ptr<std::ostringstream>(new std::
        ostringstream) );
...
bool endsWith(std::string const& s, std::string const& suffix)
{
  return s.size() >= suffix.size() && std::equal(suffix.rbegin(),
...
std::string trim(std::string const& str)
{
  ...
  return start !=
    std::string::npos ? str.substr(start, 1+end-start) : std::string();
}
...
{
  m_rootTracker =
    std::make_shared<SectionTracker>(NameAndLocation("{root}",
      CATCH_INTERNAL_LINEINFO), *this,
      nullptr);
...
std::string TestSpecParser::preprocessPattern()
{
  ...
  for (std::size_t i = 0; i < m_escapeChars.size(); ++i)
    token = token.substr(0, m_escapeChars[i] - i) + token.substr(
      m_escapeChars[i] - i + 1);
  m_escapeChars.clear();
...
void TestSpecParser::addNamePattern()
{
  ...
  if (!token.empty())
  {
    TestSpec::PatternPtr pattern = std::make_shared<TestSpec::NamePattern>(
      token, m_substring);
    if (m_exclusion)
...
void TestSpecParser::addTagPattern()
{
  ...
  if (!token.empty())
  {
    ...
    if (token.size() > 1 && token[0] == '.')
    {
      ...
      TestSpec::PatternPtr pattern = std::make_shared<TestSpec::TagPattern>(".",
          m_substring);
      if (m_exclusion)
      {
        pattern = std::make_shared<TestSpec::ExcludedPattern>(pattern);
...
{
  std::size_t ratio = total >
    0 ? CATCH_CONFIG_CONSOLE_WIDTH * number / total : 0;
...
class Duration
{
  ...
  static const uint64_t s_nanosecondsInAMillisecond = 1000 *
    s_nanosecondsInAMicrosecond;
  static const uint64_t s_nanosecondsInASecond = 1000 *
    s_nanosecondsInAMillisecond;
...
void ConsoleReporter::benchmarkPreparing(std::string const& name)
{
  ...
  auto nameCol =
    Column(name).width(static_cast<std::size_t>(m_tablePrinter->columnInfos()[
        0].width - 2));
...
{
  return
    "Reports test results in an XML format that looks like Ant's junitreport target";
}
...
void JunitReporter::writeGroup(TestGroupNode const& groupNode, double suiteTime)
{
  ...
  xml.scopedElement("system-out").writeText(trim(
      stdOutForSuite), XmlFormatting::Newline);
  xml.scopedElement("system-err").writeText(trim(
      stdErrForSuite), XmlFormatting::Newline);
}
  ...
  bool testOkToFail)
{
    ...
    !sectionNode.stdErr.empty() )
  {
    ...
    if (!sectionNode.stdErr.empty() )
      xml.scopedElement("system-err").writeText(trim(
          sectionNode.stdErr), XmlFormatting::Newline);
  }
...
void XmlReporter::testRunStarting(TestRunInfo const& testInfo)
{
  ...
  if (m_config->testSpec().hasFilters())
    m_xml.writeAttribute("filters", serializeFilters(
...
void XmlReporter::testCaseEnded(TestCaseStats const& testCaseStats)
{
  ...
  if (!testCaseStats.stdOut.empty() )
    m_xml.scopedElement("StdOut").writeText(trim(
        testCaseStats.stdOut), XmlFormatting::Newline);
  if (!testCaseStats.stdErr.empty() )
    m_xml.scopedElement("StdErr").writeText(trim(
        testCaseStats.stdErr), XmlFormatting::Newline);
...
#define CATCH_REQUIRE_THROWS(...) INTERNAL_CATCH_THROWS("CATCH_REQUIRE_THROWS", \
    Catch::ResultDisposition::Normal, \
    __VA_ARGS__)
#define CATCH_REQUIRE_THROWS_AS(expr, exceptionType) INTERNAL_CATCH_THROWS_AS( \
    "CATCH_REQUIRE_THROWS_AS", exceptionType, Catch::ResultDisposition::Normal, \
    expr)
#define CATCH_REQUIRE_THROWS_WITH(expr, \
    matcher) INTERNAL_CATCH_THROWS_STR_MATCHES("CATCH_REQUIRE_THROWS_WITH", \
    Catch::ResultDisposition::Normal, \
    matcher, expr)
#if !defined(CATCH_CONFIG_DISABLE_MATCHERS)
#define CATCH_REQUIRE_THROWS_MATCHES(expr, exceptionType, \
    matcher) INTERNAL_CATCH_THROWS_MATCHES("CATCH_REQUIRE_THROWS_MATCHES", \
    exceptionType, \
    Catch::ResultDisposition::Normal, \
    matcher, expr)
#endif // CATCH_CONFIG_DISABLE_MATCHERS
#define CATCH_REQUIRE_NOTHROW(...) INTERNAL_CATCH_NO_THROW( \
...
#define CATCH_CHECK(...) INTERNAL_CATCH_TEST("CATCH_CHECK", \
    ...
    __VA_ARGS__)
#define CATCH_CHECK_FALSE(...) INTERNAL_CATCH_TEST("CATCH_CHECK_FALSE", \
    Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::FalseTest, \
    __VA_ARGS__)
#define CATCH_CHECKED_IF(...) INTERNAL_CATCH_IF("CATCH_CHECKED_IF", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
#define CATCH_CHECKED_ELSE(...) INTERNAL_CATCH_ELSE("CATCH_CHECKED_ELSE", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
#define CATCH_CHECK_NOFAIL(...) INTERNAL_CATCH_TEST("CATCH_CHECK_NOFAIL", \
    Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::SuppressFail, \
    __VA_ARGS__)

#define CATCH_CHECK_THROWS(...)  INTERNAL_CATCH_THROWS("CATCH_CHECK_THROWS", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
#define CATCH_CHECK_THROWS_AS(expr, exceptionType) INTERNAL_CATCH_THROWS_AS( \
    "CATCH_CHECK_THROWS_AS", exceptionType, \
    Catch::ResultDisposition::ContinueOnFailure, expr)
#define CATCH_CHECK_THROWS_WITH(expr, \
    matcher) INTERNAL_CATCH_THROWS_STR_MATCHES("CATCH_CHECK_THROWS_WITH", \
...
#define CATCH_CHECK_THROWS_MATCHES(expr, exceptionType, \
    ...
    expr)
#endif // CATCH_CONFIG_DISABLE_MATCHERS
#define CATCH_CHECK_NOTHROW(...) INTERNAL_CATCH_NO_THROW("CATCH_CHECK_NOTHROW", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
...
#define CATCH_WARN(msg) INTERNAL_CATCH_MSG("CATCH_WARN", \
    Catch::ResultWas::Warning, \
    Catch::ResultDisposition::ContinueOnFailure, \
    msg)
#define CATCH_CAPTURE(...) INTERNAL_CATCH_CAPTURE(INTERNAL_CATCH_UNIQUE_NAME(\
      capturer), "CATCH_CAPTURE", __VA_ARGS__)
...
#ifndef CATCH_CONFIG_TRADITIONAL_MSVC_PREPROCESSOR
#define CATCH_TEMPLATE_TEST_CASE(...) INTERNAL_CATCH_TEMPLATE_TEST_CASE( \
    __VA_ARGS__)
...
#define CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(className, \
    ...
    __VA_ARGS__)
#else
#define CATCH_TEMPLATE_TEST_CASE(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE( \
      __VA_ARGS__) )
...
#define CATCH_TEMPLATE_TEST_CASE_METHOD(className, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD( \
      className, __VA_ARGS__) )
#define CATCH_TEMPLATE_TEST_CASE_METHOD_SIG(className, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_SIG( \
      className, \
      __VA_ARGS__) )
#define CATCH_TEMPLATE_PRODUCT_TEST_CASE(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE( \
      __VA_ARGS__) )
#define CATCH_TEMPLATE_PRODUCT_TEST_CASE_SIG(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_SIG( \
      __VA_ARGS__) )
#define CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD(className, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD( \
      className, \
      __VA_ARGS__) )
#define CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(className, \
...
#define CATCH_STATIC_REQUIRE_FALSE(...) static_assert(!(__VA_ARGS__), \
    "!(" #__VA_ARGS__ ")"); \
  CATCH_SUCCEED( #__VA_ARGS__)
#else
...
#define CATCH_SCENARIO_METHOD(className, ...) INTERNAL_CATCH_TEST_CASE_METHOD( \
    className, "Scenario: " __VA_ARGS__)
...
#define CATCH_BENCHMARK(...) \
  INTERNAL_CATCH_BENCHMARK(INTERNAL_CATCH_UNIQUE_NAME(\
      C_A_T_C_H_B_E_N_C_H_), INTERNAL_CATCH_GET_1_ARG(__VA_ARGS__, ,\
    ), \
    INTERNAL_CATCH_GET_2_ARG(__VA_ARGS__, , ))
#define CATCH_BENCHMARK_ADVANCED(name) \
  INTERNAL_CATCH_BENCHMARK_ADVANCED(INTERNAL_CATCH_UNIQUE_NAME(\
      C_A_T_C_H_B_E_N_C_H_), name)
#endif // CATCH_CONFIG_ENABLE_BENCHMARKING
...
#define REQUIRE(...) INTERNAL_CATCH_TEST("REQUIRE", \
    Catch::ResultDisposition::Normal, \
    __VA_ARGS__)
#define REQUIRE_FALSE(...) INTERNAL_CATCH_TEST("REQUIRE_FALSE", \
    Catch::ResultDisposition::Normal | Catch::ResultDisposition::FalseTest, \
    __VA_ARGS__)

#define REQUIRE_THROWS(...) INTERNAL_CATCH_THROWS("REQUIRE_THROWS", \
    Catch::ResultDisposition::Normal, \
    __VA_ARGS__)
...
#define REQUIRE_THROWS_MATCHES(expr, exceptionType, \
    matcher) INTERNAL_CATCH_THROWS_MATCHES("REQUIRE_THROWS_MATCHES", \
    exceptionType, \
    Catch::ResultDisposition::Normal, \
    matcher, expr)
#endif // CATCH_CONFIG_DISABLE_MATCHERS
#define REQUIRE_NOTHROW(...) INTERNAL_CATCH_NO_THROW("REQUIRE_NOTHROW", \
    Catch::ResultDisposition::Normal, \
    __VA_ARGS__)

#define CHECK(...) INTERNAL_CATCH_TEST("CHECK", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
...
#define CHECKED_IF(...) INTERNAL_CATCH_IF("CHECKED_IF", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
#define CHECKED_ELSE(...) INTERNAL_CATCH_ELSE("CHECKED_ELSE", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
...
#define CHECK_THROWS(...)  INTERNAL_CATCH_THROWS("CHECK_THROWS", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
#define CHECK_THROWS_AS(expr, exceptionType) INTERNAL_CATCH_THROWS_AS( \
    "CHECK_THROWS_AS", exceptionType, \
    Catch::ResultDisposition::ContinueOnFailure, expr)
#define CHECK_THROWS_WITH(expr, matcher) INTERNAL_CATCH_THROWS_STR_MATCHES( \
    "CHECK_THROWS_WITH", Catch::ResultDisposition::ContinueOnFailure, matcher, \
    expr)
#if !defined(CATCH_CONFIG_DISABLE_MATCHERS)
#define CHECK_THROWS_MATCHES(expr, exceptionType, \
    matcher) INTERNAL_CATCH_THROWS_MATCHES("CHECK_THROWS_MATCHES", \
    exceptionType, \
    Catch::ResultDisposition::ContinueOnFailure, matcher, \
    expr)
#endif // CATCH_CONFIG_DISABLE_MATCHERS
#define CHECK_NOTHROW(...) INTERNAL_CATCH_NO_THROW("CHECK_NOTHROW", \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)

#if !defined(CATCH_CONFIG_DISABLE_MATCHERS)
#define CHECK_THAT(arg, matcher) INTERNAL_CHECK_THAT("CHECK_THAT", matcher, \
    Catch::ResultDisposition::ContinueOnFailure, \
    arg)

#define REQUIRE_THAT(arg, matcher) INTERNAL_CHECK_THAT("REQUIRE_THAT", matcher, \
    Catch::ResultDisposition::Normal, \
    arg)
#endif // CATCH_CONFIG_DISABLE_MATCHERS
...
#define WARN(msg) INTERNAL_CATCH_MSG("WARN", Catch::ResultWas::Warning, \
    Catch::ResultDisposition::ContinueOnFailure, \
    msg)
#define CAPTURE(...) INTERNAL_CATCH_CAPTURE(INTERNAL_CATCH_UNIQUE_NAME(\
      capturer), "CAPTURE", __VA_ARGS__)
...
#define FAIL(...) INTERNAL_CATCH_MSG("FAIL", Catch::ResultWas::ExplicitFailure, \
    Catch::ResultDisposition::Normal, \
    __VA_ARGS__)
#define FAIL_CHECK(...) INTERNAL_CATCH_MSG("FAIL_CHECK", \
    Catch::ResultWas::ExplicitFailure, \
    Catch::ResultDisposition::ContinueOnFailure, \
    __VA_ARGS__)
...
#define TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(className, \
    ...) INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(className, \
    __VA_ARGS__)
#define TEMPLATE_LIST_TEST_CASE(...) INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE(\
    __VA_ARGS__)
#define TEMPLATE_LIST_TEST_CASE_METHOD(className, \
    ...) INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD(className, __VA_ARGS__)
#else
#define TEMPLATE_TEST_CASE(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE( \
      __VA_ARGS__) )
#define TEMPLATE_TEST_CASE_SIG(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_SIG( \
      __VA_ARGS__) )
#define TEMPLATE_TEST_CASE_METHOD(className, ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD( \
      className, \
      __VA_ARGS__) )
#define TEMPLATE_TEST_CASE_METHOD_SIG(className, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_SIG( \
      className, \
      __VA_ARGS__) )
#define TEMPLATE_PRODUCT_TEST_CASE(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE( \
      __VA_ARGS__) )
#define TEMPLATE_PRODUCT_TEST_CASE_SIG(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_SIG( \
      __VA_ARGS__) )
#define TEMPLATE_PRODUCT_TEST_CASE_METHOD(className, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD( \
      className, \
...
#define TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(className, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG( \
      className, \
      __VA_ARGS__) )
#define TEMPLATE_LIST_TEST_CASE(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE( \
      __VA_ARGS__) )
#define TEMPLATE_LIST_TEST_CASE_METHOD(className, \
    ...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_LIST_TEST_CASE_METHOD( \
      className, \
      __VA_ARGS__) )
#endif
...
#define STATIC_REQUIRE(...)       static_assert(__VA_ARGS__,  #__VA_ARGS__); \
  SUCCEED( #__VA_ARGS__)
#define STATIC_REQUIRE_FALSE(...) static_assert(!(__VA_ARGS__), \
    "!(" #__VA_ARGS__ ")"); SUCCEED( \
    "!(" #__VA_ARGS__ ")")
#else
...
#define SCENARIO_METHOD(className, ...) INTERNAL_CATCH_TEST_CASE_METHOD( \
    className, "Scenario: " __VA_ARGS__)
...
#define CATCH_TEST_CASE(...) INTERNAL_CATCH_TESTCASE_NO_REGISTRATION(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_S_T_))
#define CATCH_TEST_CASE_METHOD(className, \
    ...) INTERNAL_CATCH_TESTCASE_NO_REGISTRATION(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_S_T_))
#define CATCH_METHOD_AS_TEST_CASE(method, ...)
...
#define CATCH_ANON_TEST_CASE() INTERNAL_CATCH_TESTCASE_NO_REGISTRATION(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_S_T_))
...
#define CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(className, \
    ...) CATCH_TEMPLATE_TEST_CASE_METHOD(className, __VA_ARGS__)
#else
#define CATCH_TEMPLATE_TEST_CASE(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION(\
      __VA_ARGS__) )
#define CATCH_TEMPLATE_TEST_CASE_SIG(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_SIG_NO_REGISTRATION(\
      __VA_ARGS__) )
#define CATCH_TEMPLATE_TEST_CASE_METHOD(className, \
...
// "BDD-style" convenience wrappers
#define CATCH_SCENARIO(...) INTERNAL_CATCH_TESTCASE_NO_REGISTRATION(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_S_T_))
#define CATCH_SCENARIO_METHOD(className, \
    ...) INTERNAL_CATCH_TESTCASE_METHOD_NO_REGISTRATION(INTERNAL_CATCH_UNIQUE_NAME( \
      C_A_T_C_H_T_E_S_T_), className)
...
#define TEMPLATE_PRODUCT_TEST_CASE_METHOD_SIG(className, \
    ...) TEMPLATE_TEST_CASE_METHOD(className, __VA_ARGS__)
#else
#define TEMPLATE_TEST_CASE(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_NO_REGISTRATION(\
      __VA_ARGS__) )
#define TEMPLATE_TEST_CASE_SIG(...) INTERNAL_CATCH_EXPAND_VARGS(INTERNAL_CATCH_TEMPLATE_TEST_CASE_SIG_NO_REGISTRATION(\
      __VA_ARGS__) )
...
#define CATCH_TRANSLATE_EXCEPTION(signature) \
  INTERNAL_CATCH_TRANSLATE_EXCEPTION_NO_REG(INTERNAL_CATCH_UNIQUE_NAME( \
      catch_internal_ExceptionTranslator), signature)
